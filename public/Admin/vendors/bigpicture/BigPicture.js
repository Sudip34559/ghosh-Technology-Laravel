var BigPicture = (function () {
    ...
    function makeGallery(gallery, position) {
        ...
        if (galleryEls.length > 1) {
            ...
            galleryCounter.innerHTML =
                galleryPosition + 1 + "/" + galleryEls.length;
            if (!supportsTouch) {
    ...
    function changeGalleryImage(movement) {
        ...
        onChangeImage &&
            onChangeImage([displayImage, galleryEls[galleryPosition]]);
    }

    // create video iframe
    function createIframe() {
        var url =
            "https://www.youtube.com/embed/videoseries?list=PLUClgwrrwtQka2PGKCW1R2mNTBoMAXWF-";
        // var prefix = 'https://';
    ...
    function open(err) {
        ...
        if (typeof err === "string") {
            ...
            return opts.onError
                ? opts.onError()
                : alert(
                      "Error: The requested " + err + " could not be loaded."
                  );
        }
